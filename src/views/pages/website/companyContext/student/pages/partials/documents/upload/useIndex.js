...
export default function useIndex({ props }) {
  ...
  const documentColumns = [
    { field: 'document_type', title: t('companyContext.student.document_type') },
    { field: 'accept', title: t('companyContext.student.extension') },
  ...
  const additionalDocumentColumns = [
    { field: 'description', title: t('companyContext.student.document_name') },
    { field: 'document', title: t('companyContext.student.document') },
    // { field: 'file_original_name', title: 'File name' },
    { field: 'actions', title: t('system.actions'), sort: false },
  ]
