<template>
  <!-- Header -->
  <header class="header header-eight min-header">
    <div class="header-fixed header-fixed-wrap">
      <nav class="navbar navbar-expand-lg header-nav header-nav-eight">
        <div class="navbar-header">
          ...
          <router-link to="/" class="navbar-brand navbar-brand-eight logo">
        ...
        <ul class="nav header-navbar-rht header-navbar-rht-eight">
          <li class="nav-item">
            <router-link class="nav-link btn btn-register" to="/pages/register"
              ><i class="fas fa-sign-in-alt"></i> Sign Up</router-link
            >
          </li>
          <li class="nav-item">
            <router-link class="nav-link btn btn-login" to="pages/login"
              ><i class="fas fa-lock"></i> Sign In</router-link
            >
          </li>
        </ul>
      </nav>
