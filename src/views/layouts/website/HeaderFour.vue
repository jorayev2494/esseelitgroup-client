            ...
            <ul class="main-nav">
                      ...
                      <div class="row">
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index' }">
                            <div class="demo-img">
                              <router-link to="/" class="inner-demo-img"><img src="@/assets/img/home-1.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
                              <router-link to="/" class="inner-demo-img">Home - 1</router-link>
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index-2' }">
                            <div class="demo-img">
                              <router-link to="/index-2" class="inner-demo-img"><img src="@/assets/img/home-2.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
                        ...
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index-3' }">
                            <div class="demo-img">
                              <router-link to="/index-3" class="inner-demo-img"><img src="@/assets/img/home-3.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
                        ...
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index-4' }">
                            <div class="demo-img">
                              <router-link to="/index-4" class="inner-demo-img"><img src="@/assets/img/home-4.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
                        ...
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index-5' }">
                            <div class="demo-img">
                              <router-link to="/index-5" class="inner-demo-img"><img src="@/assets/img/home-6.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
                        ...
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index-6' }">
                            <div class="demo-img">
                              <router-link to="/index-6" class="inner-demo-img"><img src="@/assets/img/home-8.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
                        ...
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index-7' }">
                            <div class="demo-img">
                              <router-link to="/index-7" class="inner-demo-img"><img src="@/assets/img/home-7.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
                        ...
                        <div class="col-lg-3">
                          <div class="single-demo" v-bind:class="{ active: currentPath == 'index-8' }">
                            <div class="demo-img">
                              <router-link to="/index-8" class="inner-demo-img"><img src="@/assets/img/home-5.jpg"
                                  class="img-fluid" alt="img" /></router-link>
                            </div>
                            <div class="demo-info">
              ...
              <li class="has-submenu" v-bind:class="{ active: pagesMenu }">
                ...
                <ul class="submenu">
                  ...
                  <li>
                    <router-link to="/mentee/mentor-search">Search Mentors</router-link>
                  </li>
