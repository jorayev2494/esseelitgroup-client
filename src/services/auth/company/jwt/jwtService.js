...
export default class JwtService {
  ...
  setAccessToken(value) {
    store.commit('companyContext/auth/setAccessToken', value);
  ...
  login(...args) {
    return new Promise((resolve, reject) => {
      return this.httpClientIns.post(this.jwtConfig.loginEndpoint, ...args).then(response => {
        ...
        this.setCompany(authData);
        // store.commit('companyContext/company/setCompany', company)
        // this.setAuthData();
  ...
  setProfile(payload) {
    store.commit('companyContext/auth/setAuthData', payload)
  }
